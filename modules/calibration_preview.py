...
FIELDS = [
    ...
    {
        "label": "Segel",
        "desc": "X=90.9, Y=18.3 / X=22.4, Y=18.3",
        "sample": "封",
        "x": 90.9, "y": 18.3,
        "vertical": False,
        "spacing": 0,
